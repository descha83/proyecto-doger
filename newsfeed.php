<?php
  ...
  // if ( !isLogged() ) {
 	...
 	// 	exit;
  //  }
      $pageTitle = 'Ponete al día con la comunidad';
    	...
    	<div class="container">
          ...
          ================================================= -->
            ...
            <div class="profile-card">
            	<img src="data/avatars/<?= $theUser['avatar']; ?>" alt="imagen usuario" class="profile-photo" />
            	<h5><a href="#" class="text-white"><?= $theUser['name']; ?></a></h5>
            	<a href="#" class="text-white"><?= $theUser['email']; ?></a>
